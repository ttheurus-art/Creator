...
function WindowClass:_UpdateResponsiveSize()
    ...
    local width = math.clamp(viewport.X * 0.74, 290, 600)
    local height = math.clamp(width * 0.82, 280, 430)

    if viewport.X < 560 then
        width = math.max(280, viewport.X - 32)
        height = math.clamp(width * 0.82, 270, 390)
    end
